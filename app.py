...
MSR_AZURE_COSMOSDB_FORMDATA_ACCOUNT = os.environ.get("MSR_AZURE_COSMOSDB_FORMDATA_ACCOUNT")
MSR_AZURE_COSMOSDB_FORMDATA_DATABASE = os.environ.get("MSR_AZURE_COSMOSDB_FORMDATA_DATABASE")
...
if MSR_AZURE_COSMOSDB_FORMDATA_ACCOUNT and MSR_AZURE_COSMOSDB_FORMDATA_DATABASE and MSR_AZURE_COSMOSDB_FORMDATA_CONTAINER and MSR_AZURE_COSMOSDB_FORMDATA_ENABLED:
    try:
